    ...
    return (
        ...
        <div className="d-flex align-items-center justify-content-between">
            <Button
                type="button"
                variant="anger"
                className="text-white bg-btn-pink btn-rounded btn-block me-1 w-100 py-3 rounded-10 px-3"
            ...
            <Button
                type="button"
                variant="anger"
                className="text-white btn-danger btn-rounded btn-block me-1 w-100 py-3 rounded-10 px-3"
            ...
            {/* <Button
                type="button"
                variant="success"
                className="text-white w-100 py-3 me-1 rounded-10 px-3 pos-pay-btn"
